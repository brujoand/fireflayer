...
def test_extract_payment_tag():
    flay_config = {"function": "extract_tag", "arguments": {"source_field": "description", "pattern": r"^(.+)\ ?\*", "group": 1}}

    transaction = {"transaction_journal_id": 1337, "description": "PayPal *Ice Cream 4 Realz", "tags": ["some existing tag"]}
...
def test_remove_payment_tag():
    flay_config = {"function": "replace", "arguments": {"source_fields": ["description", "destination_name"], "pattern": r"^(.+)\ ?\*", "value": ""}}
...
def test_destination_by_tags():
    ...
    flay_config = {"function": "destination_by_tags", "arguments": {"tag_names": ["PayPal"]}}

    transaction = {"transaction_journal_id": 1337, "destination_id": 69, "destination_name": "HTNS456HTNS", "tags": ["PayPal"]}
